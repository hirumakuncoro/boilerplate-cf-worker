/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0d0ffc1fdc4317cde658eafb7c8db25f)
...
interface __BaseEnv_CloudflareBindings {
	...
	STORAGE_PUBLIC_URL: "http://localhost:9000/global" | "http://localhost/global";
	MINIO_ENDPOINT: "http://localhost:9000" | "http://localhost";
	MINIO_BUCKET: "global";
	DATABASE_URL: string;
	JWT_SECRET: string;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		DB_DRIVER: "pg";
		STORAGE_DRIVER: "r2";
		STORAGE_PUBLIC_URL: "http://localhost/global";
